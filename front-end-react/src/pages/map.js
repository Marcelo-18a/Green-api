...
export default function MapPage() {
  ...
  useEffect(() => {
    const fetchSamples = async () => {
      try {
        ...
        showError("Erro ao carregar dados das amostras. Tente novamente.");
  ...
  const refreshSamples = async () => {
    ...
    try {
      ...
      setError(null);
      showSuccess("Dados do mapa atualizados com sucesso!");
    } catch (error) {
      console.error("Erro ao recarregar amostras:", error);
      showError("Erro ao recarregar dados. Tente novamente.");
                  ...
                  <div className={styles.infoCard}>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        {samples.filter((s) => s.localizacao?.latitude).length}
                      </li>
                      <li>
